...
# FIX: 'Objective' object has no attribute 'id'. Access the reaction's ID directly.
print(f"Objective Value ({ex_faee_c_export.id}): {solution.objective_value}") # Print the ID of the objective
